      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="px-2 py-1 text-xs font-medium bg-accent-gold/10 text-accent-gold rounded border border-accent-gold/20 capitalize">
              {dataset.domain}
            </span>
          </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-white">{ranking.baseline.name}</span>
...
export function SemanticCacheDatasetsPage() {
  ...
  return (
    <div>
      <h2 className="text-4xl font-bold text-white mb-6">Benchmark Datasets</h2>

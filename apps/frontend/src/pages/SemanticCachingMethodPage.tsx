...
function SemanticCacheLeaderboardSection() {
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-4xl font-bold font-quantico text-white">Overall Rankings</h2>
...
/**
 * SemanticCachingMethodPage displays the full semantic caching research content.
 * 
 * Composition: Reuses existing semantic cache components with MethodLayout wrapper
 * for consistent structure aligned with sparse attention method page.
 */
export function SemanticCachingMethodPage() {
  return (
    <PageLayout spacing="normal" maxWidth="full">
      <MethodLayout>
        ...
        <div id="leaderboard-section" className="scroll-mt-24">
          <SemanticCacheLeaderboardSection />
        </div>

        {/* Divider */}
        <div className="my-12 border-t border-dark-border"></div>

        {/* Datasets Section */}
        <div id="datasets-section" className="scroll-mt-24">
          <SemanticCacheDatasetsPage />
        </div>
      </MethodLayout>
    </PageLayout>
  );

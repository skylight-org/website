...
export function BaselineDetailPage() {
  ...
  const paperUrl = baseline.paperUrl || metadata?.paperUrl; // Use metadata as fallback
  const abstract = baseline.abstract || metadata?.abstract; // Use metadata as fallback
  ...
  return (
    <div className="space-y-8">
      ...
      {/* About Section (fallback if no abstract) */}
      ...
      <div className="bg-dark-surface rounded-lg border border-dark-border p-6">
        ...
        <p className="text-gray-300">
          ...
          datasets, please visit the <a href="/" className="text-accent-gold hover:underline">Overview page</a>.
        </p>
      </div>
    </div>
  );
